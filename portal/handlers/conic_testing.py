...
def parabola_parameters(equation):
    ...
    if "=" in equation:
        right_of_equals = equation.split("=")[1].strip()
    else:
        right_of_equals = equation

    # Extract the expression from the right side
    parsed_eq = sp.sympify(right_of_equals)
...
# Example usage:
# equation = "y = x**2 + 2x + 1"
# parameters = parabola_parameters(equation)
# print(parameters)
